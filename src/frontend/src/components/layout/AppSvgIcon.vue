<!--
  ...
  图标库为内置字典（24x24 视图、stroke 描边），不使用 emoji。
  用法：<AppSvgIcon name="home" :size="20" />
-->
<script setup lang="ts">
withDefaults(defineProps<{ name: string; size?: number }>(), { size: 24 });

/** 图标字典：name -> SVG 内部元素（stroke 风格，lucide 风格路径） */
const ICONS: Record<string, string> = {
  home: '<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',
  blocks:
    '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>',
  apps: '<rect x="2" y="4" width="20" height="16" rx="2"/><path d="M10 4v4"/><path d="M2 8h20"/><path d="M6 4v4"/>',
